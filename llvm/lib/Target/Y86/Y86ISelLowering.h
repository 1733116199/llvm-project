...
namespace llvm {
  namespace Y86ISD {
    enum NodeType : unsigned {
      ...
      /// Y86 conditional branches. Operand 0 is the chain operand, operand 1
  ...
  class Y86Subtarget;
  class Y86TargetLowering : public TargetLowering {
  public:
    explicit Y86TargetLowering(const TargetMachine &TM,
    ...
    /// Ty1 to type Ty2. e.g. On y86 it's free to truncate a i16 value in
    ...
    /// necessarily apply to truncate instructions. e.g. on y86, all
