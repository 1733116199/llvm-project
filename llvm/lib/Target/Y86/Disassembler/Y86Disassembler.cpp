//===-- Y86Disassembler.cpp - Disassembler for Y86 ------------------===//
//
...
//===----------------------------------------------------------------------===//
//
// This file implements the Y86Disassembler class.
//
//===----------------------------------------------------------------------===//
...
#define DEBUG_TYPE "y86-disassembler"

typedef MCDisassembler::DecodeStatus DecodeStatus;

namespace {
class Y86Disassembler : public MCDisassembler {
...
public:
  Y86Disassembler(const MCSubtargetInfo &STI, MCContext &Ctx)
...
static MCDisassembler *createY86Disassembler(const Target &T,
                                                const MCSubtargetInfo &STI,
                                                MCContext &Ctx) {
  return new Y86Disassembler(STI, Ctx);
}

extern "C" LLVM_EXTERNAL_VISIBILITY void LLVMInitializeY86Disassembler() {
  TargetRegistry::RegisterMCDisassembler(getTheY86Target(),
                                         createY86Disassembler);
}

static const unsigned GR8DecoderTable[] = {
  Y86::PCB,  Y86::SPB,  Y86::SRB,  Y86::CGB,
  Y86::R4B,  Y86::R5B,  Y86::R6B,  Y86::R7B,
  Y86::R8B,  Y86::R9B,  Y86::R10B, Y86::R11B,
  Y86::R12B, Y86::R13B, Y86::R14B, Y86::R15B
};
...
#include "Y86GenDisassemblerTables.inc"
...
DecodeStatus Y86Disassembler::getInstructionI(MCInst &MI, uint64_t &Size,
...
DecodeStatus Y86Disassembler::getInstructionII(MCInst &MI, uint64_t &Size,
                                                  ArrayRef<uint8_t> Bytes,
                                                  uint64_t Address,
                                                  raw_ostream &CStream) const {
  uint64_t Insn = support::endian::read16le(Bytes.data());
...
static Y86CC::CondCodes getCondCode(unsigned Cond) {
  switch (Cond) {
  case 0: return Y86CC::COND_NE;
  case 1: return Y86CC::COND_E;
  case 2: return Y86CC::COND_LO;
  case 3: return Y86CC::COND_HS;
  case 4: return Y86CC::COND_N;
  case 5: return Y86CC::COND_GE;
  case 6: return Y86CC::COND_L;
  case 7: return Y86CC::COND_NONE;
  default:
    llvm_unreachable("Cond out of range");
  }
}

DecodeStatus Y86Disassembler::getInstructionCJ(MCInst &MI, uint64_t &Size,
                                                  ArrayRef<uint8_t> Bytes,
                                                  uint64_t Address,
                                                  raw_ostream &CStream) const {
  uint64_t Insn = support::endian::read16le(Bytes.data());
  ...
  if (Cond == 7)
    MI.setOpcode(Y86::JMP);
  else {
    MI.setOpcode(Y86::JCC);
...
DecodeStatus Y86Disassembler::getInstruction(MCInst &MI, uint64_t &Size,
                                                ArrayRef<uint8_t> Bytes,
                                                uint64_t Address,
                                                raw_ostream &CStream) const {
  if (Bytes.size() < 2) {
